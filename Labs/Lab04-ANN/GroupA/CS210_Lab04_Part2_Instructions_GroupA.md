...
Your goal is to apply the exact same steps you learned in the "Basic image classification" tutorial (which used the Fashion MNIST dataset) to a new, slightly more complex dataset: CIFAR-10.
